...
4. Защита от дублей сделана в два слоя:
   - distributed lock в Redis
...
- идемпотентность и anti-duplicate защита для hourly jobs
- hashed safety identifier для OpenAI text generation
